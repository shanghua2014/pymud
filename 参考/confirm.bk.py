...
class InputDialog(BasicDialog):
    def __init__(self, title = "请输入"):
        self.textInput = TextArea(name = "input", text="", multiline=False, wrap_lines=False, height = 1, dont_extend_height=True, width = D(preferred=10), focus_on_click=True, read_only=False)
